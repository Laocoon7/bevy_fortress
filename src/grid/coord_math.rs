...
impl Add for Size {
    ...
    fn add(self, size: Size) -> Self::Output { Size::new(self.x() + size.x(), self.y() + size.y()) }
}
...
impl<'a> Add<&'a Size> for Size {
    ...
    fn add(self, size: &'a Size) -> Self::Output { Size::new(self.x() + size.x(), self.y() + size.y()) }
}
...
impl Sub for Size {
    ...
    fn sub(self, size: Size) -> Self::Output { Size::new(self.x() - size.x(), self.y() - size.y()) }
}
...
impl<'a> Sub<&'a Size> for Size {
    ...
    fn sub(self, size: &'a Size) -> Self::Output { Size::new(self.x() - size.x(), self.y() - size.y()) }
}
...
impl Mul<u32> for Size {
    ...
    fn mul(self, rhs: u32) -> Self::Output { Size::new(self.x() * rhs, self.y() * rhs) }
}
...
impl Div<u32> for Size {
    ...
    fn div(self, rhs: u32) -> Self::Output { Size::new(self.x() / rhs, self.y() / rhs) }
}
